            ...
            return {
                ...
                link: function (scope, element, attrs, controllers) {
                    ...
                    $q.when().then(function () {
                        ...
                        ionAutocompleteController.initSelectedItem = function () {
                            if (angular.isDefined(attrs.selectItemsMethod)) {
                                var promise = $q.when(ionAutocompleteController.selectItemsMethod());
                                promise.then(function (promiseData) {
                                    ionAutocompleteController.selectedItems = promiseData;
                                });
                            }
                        };
                        ...
                        var onClick = function (event) {
                            ...
                            ionAutocompleteController.initSelectedItem();
